...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['codigo'])) {
            ...
            $sql = "SELECT email, codigo, validade FROM recuperacao_senha_funcionario WHERE codigo = :codigo";
            ...
            if ($stmt->rowCount() > 0) {
                ...
                if (new DateTime() < new DateTime($row['validade'])) {
                    ...
                    $sqlDelete = "DELETE FROM recuperacao_senha_funcionario WHERE codigo = :codigo";
