...
if (!isset($_GET['id'])) {
    echo json_encode(['error' => 'ID do storage não fornecido.']);
    exit;
}
...
try {
    ...
    if ($storage) {
        ...
        echo json_encode(['error' => 'Storage não encontrado.']);
    }

} catch (PDOException $e) {
    // Em caso de erro, retorna uma mensagem de erro
    echo json_encode(['error' => 'Erro ao buscar dados do storage: ' . $e->getMessage()]);
}
?>
