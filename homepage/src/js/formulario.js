...
document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener('submit', function (event) {
        ...
        fetch('https://www.yourstorage.x10.mx/homepage/php/process_form.php', {
            method: 'POST',
            body: formData,
        })
            ...
            .then(dados => {
                ...
                if (dados.error) {
                    // Exibe erro na div #message
                    messageDiv.style.display = 'flex'; 
                } else if (dados.success) {
                    // Redireciona para a página de sucesso
                    window.location.href = './formulariopendente.html'; 
                }

                // Após 5 segundos, esconde a div
                setTimeout(() => {
                    messageDiv.style.display = 'none';
                }, 5000);
            })
            .catch(error => {
                // Em caso de erro de conexão ou algo inesperado
